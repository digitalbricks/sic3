...
Inspired by a [contribution of a user named "Slugger" in the WBCE forum](https://forum.wbce.org/viewtopic.php?pid=48034#p48034) I implemented an basic addon system which allows for extending SIC 3 functionality. His contribution, the [Versioncheck Addon](addons/Versioncheck/README.md) was adapted to this new addon system and is [included in this repo](addons/Versioncheck/README.md). You will also find a [Helloworld Addon](addons/Helloworld_/README.md) bundled with SIC, which demonstrates the basics of the addon system. There is also a [README.md](addons/README.md) inside the `addons` folder with more information.
